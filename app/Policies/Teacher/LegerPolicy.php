...
class LegerPolicy
{
    ...
    {
        return $this->hasAccess($user, 'view_any_teacher::leger');
    }
    ...
    {
        return $this->hasAccess($user, 'create_teacher::leger');
    }
    ...
    {
        return $this->hasAccess($user, 'delete_any_teacher::leger');
    }
    ...
    {
        return $this->hasAccess($user, 'force_delete_any_teacher::leger');
    }
    ...
    {
        return $this->hasAccess($user, 'restore_any_teacher::leger');
    }
    ...
    {
        return $this->hasAccess($user, 'reorder_teacher::leger');
    }
}
